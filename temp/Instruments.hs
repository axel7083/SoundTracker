...
createPeriode _ 0 = []
createPeriode instruction count = createPeriode instruction (count - 1) ++ [computeNote instruction ((fromIntegral count)/44100)]
...
-- These are the param used for every function
